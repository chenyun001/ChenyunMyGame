    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                half3 Emission = ( i.vertexColor * i.vertexColor.a * _diffuse_color * ( SAMPLE_TEXTURE2D( _diffuse_mask,sampler_diffuse_mask,uv_TexCoord142 ).r * SAMPLE_TEXTURE2D( _diffuse_texture,sampler_diffuse_texture,uv_TexCoord8 ).r ) * clampResult154 ).rgb;
                half Alpha = 1;
