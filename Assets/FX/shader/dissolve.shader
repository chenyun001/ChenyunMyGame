...
Shader "京沅/dissolve"
{
    ...
    SubShader {
        ...
        Pass {
            ...
            TEXTURE2D(_diffuse_mask); SAMPLER(sampler_diffuse_mask);
            TEXTURE2D(_diffuse_texture); SAMPLER(sampler_diffuse_texture);
            TEXTURE2D(_rongjie_maks); SAMPLER(sampler_rongjie_maks);
             TEXTURE2D(_rongjie_tex); SAMPLER(sampler_rongjie_tex);
            struct VertexInput {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float temp_output_16_0 = ( SAMPLE_TEXTURE2D( _diffuse_mask, sampler_diffuse_mask ,uv_diffuse_mask ).r * SAMPLE_TEXTURE2D( _diffuse_texture,sampler_diffuse_texture,uv_TexCoord96 ).r );
                ...
                float temp_output_88_0 = ( SAMPLE_TEXTURE2D( _rongjie_maks,sampler_rongjie_maks,uv_rongjie_maks ).r * SAMPLE_TEXTURE2D( _rongjie_tex,sampler_rongjie_tex,uv_rongjie_tex ).r );
