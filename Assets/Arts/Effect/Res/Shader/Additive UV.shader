    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 tex2DNode2 = tex2D(_ParticleColor, (uv0_ParticleColor + appendResult22));
                float4 temp_cast_0 = (_Texturepower).xxxx;
                half3 Emission = ((_TintColor * pow(tex2DNode2 , temp_cast_0) * i.vertexColor * _glow) * (_TintColor.a * tex2DNode2.a * i.vertexColor.a)).rgb;
                half Alpha = 1;
