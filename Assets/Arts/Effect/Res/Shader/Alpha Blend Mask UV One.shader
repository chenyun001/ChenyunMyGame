...
Shader "ASE/Effect/Alpha Blend Mask UV One" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                half Alpha = (_TintColor.a * (pow(tex2DNode2.a , _Texturepower) * _TextureAlpha) * i.vertexColor.a * (pow(tex2D(_ParticleTextureMask, (uv0_ParticleTextureMask + appendResult29)).a , _MaskPower) * _MaskIntencity));
