...
Shader "ASE/Effect/Alpha Blend Mask Noise UV" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                clip(step(_Noise , (tex2D(_TextureNoise, (uv0_TextureNoise + appendResult38)).a* tex2D(_ParticleTextureMask, uv_ParticleTextureMask).a)) - _Cutoff);
