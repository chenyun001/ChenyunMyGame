...
Shader "ASE/Effect/Alpha Blend Dissolve" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float lerpResult39 = lerp(_softValue , -1.5 , i.uv2_texcoord2.x);
                float clampResult42 = clamp(((tex2D(_TextureDissolve, uv_TextureDissolve).a * _softValue) - lerpResult39) , 0.0 , 1.0);
                half Alpha = (_TintColor.a * (pow(tex2DNode2.a , _Texturepower) * _TextureAlpha) * i.vertexColor.a * clampResult42);
