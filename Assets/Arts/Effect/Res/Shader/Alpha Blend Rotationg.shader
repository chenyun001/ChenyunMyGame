...
Shader "ASE/Effect/Alpha Blend Rotationg" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float cos15 = cos((_rotatong * _Time.y));
                float sin15 = sin((_rotatong * _Time.y));
                float2 rotator15 = mul(uv0_ParticleColor - float2(0.5,0.5) , float2x2(cos15 , -sin15 , sin15 , cos15)) + float2(0.5,0.5);
                float4 tex2DNode2 = tex2D(_ParticleColor, rotator15);
                half3 Emission = (_TintColor * tex2DNode2 * i.vertexColor * _TextureIntencity).rgb;
                float clampResult14 = clamp(pow((tex2DNode2.a * _TextureAlpha) , _Texturepower) , 0.0 , 2.0);
                half Alpha = (_TintColor.a * clampResult14 * i.vertexColor.a);
