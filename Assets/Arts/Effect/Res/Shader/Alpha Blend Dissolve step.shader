...
Shader "ASE/Effect/Alpha Blend Dissolve step" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float clampResult26 = clamp(step(i.uv2_texcoord2.x , (pow(tex2D(_particleTextureDissolve, uv_particleTextureDissolve).a , _DissolvePower) * _DissolveIntencity)) , 0.0 , 1.0);
                half Alpha = (_TintColor.a * (pow(tex2DNode2.a , _Texturepower) * _TextureAlpha) * i.vertexColor.a * clampResult26);
