...
Shader "ASE/Effect/Additive Fresnel Dissolve" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            struct VertexOutput {
                ...
                float2 uv2_texcoord2 : TEXCOORD3;
            };
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float3 ase_worldViewDir = normalize(GetWorldSpaceViewDir(ase_worldPos));
                ...
                float clampResult30 = clamp((i.uv2_texcoord2.x + (pow(tex2D(_particleTextureDissolve, uv_particleTextureDissolve).a , _DissolvePower) * _DissolveIntencity)) , 0.0 , 1.0);
                half3 Emission = (tex2DNode21.a * _Color.a * i.vertexColor.a * (tex2DNode21 * _Color * fresnelNode13 * i.vertexColor) * clampResult30).rgb;
                half Alpha = 1;
