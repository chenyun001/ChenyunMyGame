...
Shader "ASE/Effect/Alpha Blend Mask UV" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                half Alpha = (_TintColor.a * pow((tex2DNode2.a * _TextureAlpha) , _Texturepower) * i.vertexColor.a * (pow(tex2D(_ParticleTextureMask, (uv0_ParticleTextureMask + appendResult29)).a , _MaskPower) * _MaskIntencity));
