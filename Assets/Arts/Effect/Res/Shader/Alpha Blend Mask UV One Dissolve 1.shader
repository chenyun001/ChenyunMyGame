...
Shader "ASE/Effect/Alpha Blend Mask UV One Dissolve 1" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 temp_output_37_0 = (uv0_ParticleColor + appendResult36);
                float4 tex2DNode2 = tex2D(_ParticleColor, temp_output_37_0);
                ...
                float  clampResult57 = clamp(step(i.uv2_tex3coord2.z , (pow(tex2D(_particleTextureDissolve, temp_output_37_0).a , _DissolvePower) * _DissolveIntencity)) , 0.0 , 1.0);
                half  Alpha = (_TintColor.a * (pow(tex2DNode2.a , _Texturepower) * _TextureAlpha) * i.vertexColor.a * (pow(tex2D(_ParticleTextureMask, (uv0_ParticleTextureMask + appendResult29)).a , _MaskPower) * _MaskIntencity) * clampResult57);
