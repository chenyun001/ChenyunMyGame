...
Shader "ASE/Effect/Alpha Blend Mask UV One Dissolve" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            struct VertexOutput {
                ...
                float3 uv2_tex3coord2: TEXCOORD2;
                float4 vertexColor : COLOR;
            };
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 appendResult36 = (float2(i.uv2_texcoord2.x , i.uv2_texcoord2.y));
                float4 tex2DNode2 = tex2D(_ParticleColor, (uv0_ParticleColor + appendResult36));
                ...
                float2 uv0_TextureDissolve = i.uv_texcoord * _TextureDissolve_ST.xy + _TextureDissolve_ST.zw;
                float2 appendResult45 = (float2((_DissolveUSpeed * _Time.y) , (_Time.y * _DissolveVSpeed)));
                float lerpResult62 = lerp(_softValue , -1.5 , i.uv2_tex3coord2.z);
                float clampResult64 = clamp(((tex2D(_TextureDissolve, (uv0_TextureDissolve + appendResult45)).a * _softValue) - lerpResult62) , 0.0 , 1.0);
                half Alpha = (_TintColor.a * (pow(tex2DNode2.a , _Texturepower) * _TextureAlpha) * i.vertexColor.a * (pow(tex2D(_ParticleTextureMask, (uv0_ParticleTextureMask + appendResult29)).a , _MaskPower) * _MaskIntencity) * clampResult64);
