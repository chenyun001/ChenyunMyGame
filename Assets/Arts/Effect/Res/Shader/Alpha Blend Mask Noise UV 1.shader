...
Shader "ASE/Effect/Alpha Blend Mask Noise UV 1" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                float2 uv0_ParticleTexture = i.uv_texcoord * _ParticleTexture_ST.xy + _ParticleTexture_ST.zw;
                ...
                half Alpha = ((pow(tex2D(_ParticleTextureMask, (uv0_ParticleTextureMask + appendResult31)).a , _MaskPower) * _MaskIntencity) * pow(tex2DNode2.a , _TexturePower) * i.vertexColor.a);
