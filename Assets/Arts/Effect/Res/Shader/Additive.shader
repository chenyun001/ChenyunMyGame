...
Shader "ASE/Effect/Additive" {
    Properties {
        ...
        _Txeturepower("Txeture power", Float) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                float2 uv_ParticleColor = i.uv0 * _ParticleColor_ST.xy + _ParticleColor_ST.zw;
                float4 tex2DNode2 = tex2D(_ParticleColor, uv_ParticleColor);
                half3  Emission = ((_TintColor * tex2DNode2 * i.vertexColor * _TextureIntencity) * (_TintColor.a * pow(tex2DNode2.a , _Txeturepower) * i.vertexColor.a)).rgb;
                half Alpha = 1;
