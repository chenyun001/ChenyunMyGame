...
Shader "ASE/Effect/Alpha Blend Mask Dissolve Hard Edges" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float clampResult41 = clamp((pow(tex2D(_particleTextureDissolve, uv_particleTextureDissolve).a , _DissolvePower) * _DissolveIntencity) , 0.0 , 1.0);
                half Alpha = (_TintColor.a * (pow(tex2DNode2.a , _Texturepower) * _TextureAlpha) * i.vertexColor.a * (pow(tex2D(_ParticleTextureMask, uv_ParticleTextureMask).a , _MaskPower) * _MaskIntencity) * step(i.uv2_texcoord2.x , clampResult41));
