...
Shader "ASE/Effect/Additive Fresnel UV" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 appendResult28 = (float2((_Uspeed * _Time.y) , (_Time.y * _Vspeed)));
                float4 tex2DNode21 = tex2D(_TextureEmission, (uv0_TextureEmission + appendResult28));
