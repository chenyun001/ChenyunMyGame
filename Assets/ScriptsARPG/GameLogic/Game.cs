...
public class GameScript : MonoBehaviour
{
    ...
    public System.Action<float> AShowPlayerInfo;
    public static GameScript Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = (new GameObject("_Game")).AddComponent<GameScript>();
    ...
    public void AddDelegatePlayerInfo(System.Action<float> action)
    {
        this.AShowPlayerInfo = action;
    }
