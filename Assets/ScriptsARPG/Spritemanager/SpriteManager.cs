...
public class SpriteManager : MonoBehaviour
{
	...
	protected SpriteEx[] sprites;    // Array of all sprites (the offset of the vertices corresponding to each sprite should be found simply by taking the sprite's index * 4 (4 verts per sprite).
	...
	protected int EnlargeArrays(int count)
	{
		...
		// Resize sprite array:
		SpriteEx[] tempSprites = sprites;
		sprites = new SpriteEx[sprites.Length + count];
		...
		for (int i = firstNewElement ; i < sprites.Length ; ++i)
		{
			...
			sprites[i] = (SpriteEx)dummyGO.AddComponent(typeof(SpriteEx));
	...
	public SpriteEx AddSprite(GameObject client, float width, float height, int leftPixelX, int bottomPixelY, int pixelWidth, int pixelHeight, bool billboarded)
	{
	...
	public SpriteEx AddSprite(GameObject client, float width, float height, Vector2 lowerLeftUV, Vector2 UVDimensions, bool billboarded)
	{
		int spriteIndex;
	...
	public void RemoveSprite(SpriteEx sprite)
	{
	...
	public void HideSprite(SpriteEx sprite)
	{
		// Remove the sprite from the billboarded list
	...
	public void ShowSprite(SpriteEx sprite)
	{
	...
	public SpriteEx GetSprite(int i)
	{
		if (i < sprites.Length)
			return sprites[i];
		else
	...
	public void Transform(SpriteEx sprite)
	{
		sprite.Transform();
    ...
    public void TransformToGround(SpriteEx sprite)
    {
	...
	public void TransformBillboarded(SpriteEx sprite)
	{
	...
	public void UpdateUV(SpriteEx sprite)
	{
	...
	public void UpdateColors(SpriteEx sprite)
	{
	...
	virtual protected void Update()
	{
		...
		for (int i = 0 ; i < count ; i++)
			TransformBillboarded(activeBillboards[i] as SpriteEx);
	}
